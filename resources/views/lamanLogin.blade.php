                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center">
                            <div class="w-90 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ asset('images/pages/login-v2.svg') }}" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="text-center mt-2">
                                    ...
                                    <a href="page-auth-register-v2.html"><span>&nbsp;Create an account</span></a>
                                </p>
                            </div>
                        </div>
                        <!-- /Login-->
